...
func TestSearchServerPatchDataSet(t *testing.T) {
	cases := []TestCasePatchDataSet{
		{
			Url:              "https://127.0.0.1:8080/?limit=26&offset=24&query=&order_field=Age&order_by=1",
			TestPatchDataSet: "dataSetNoXml.xml",
			Response:         "couldn't parse file dataSetNoXml.xml",
			StatusCode:       500,
		},
		{
			Url:              "https://127.0.0.1:8080/?limit=26&offset=24&query=&order_field=Age&order_by=1",
			TestPatchDataSet: "dataSetWrongId.xml",
			Response:         "in dataSetWrongId.xml incorrect id",
			StatusCode:       500,
		},
		{
			Url:              "https://127.0.0.1:8080/?limit=26&offset=24&query=&order_field=Age&order_by=1",
			TestPatchDataSet: "dataSetWrongAge.xml",
			Response:         "in dataSetWrongAge.xml incorrect age",
			StatusCode:       500,
		},
	}
	for caseNum, item := range cases {
